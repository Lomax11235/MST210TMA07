...
v_0=31.2928#70 mph 31.2928
a_0=-1.14 #accerlation
T=0.7 # Thinking time
t_c=0.25 # Time interval
lines_to_ignore=30 # Lines get very close, so we need to ingore the last 20-30 m
...
ax3.plot([0,y1_max],[10,10],'dimgrey', label='junction') #Junction
ax.legend(loc='lower left',ncol=3)#Add legend
